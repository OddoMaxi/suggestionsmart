...
<div class="w-full max-w-sm">
    ...
    <form action="<?php echo e(route('suggestion.suivi.resultat', ':ref')); ?>"
          method="GET"
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($suggestion)): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($suggestion): ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="px-5 py-4 bg-<?php echo e($statutConfig['color']); ?>-50 border-b border-<?php echo e($statutConfig['color']); ?>-100">
                    <div class="flex items-center gap-3">
                        <span class="text-2xl"><?php echo e($statutConfig['icon']); ?></span>
                        <div>
                            <p class="font-bold text-<?php echo e($statutConfig['color']); ?>-800 text-sm"><?php echo e($statutConfig['label']); ?></p>
                            <p class="text-<?php echo e($statutConfig['color']); ?>-600 text-xs"><?php echo e($statutConfig['desc']); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-5 py-4 space-y-3">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-mono font-bold text-gray-800 text-sm"><?php echo e($suggestion->reference); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-semibold text-gray-700">
                            <?php echo e($typeConfig['emoji']); ?> <?php echo e($typeConfig['label']); ?>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-semibold text-gray-700 text-right max-w-[180px]">
                            <?php echo e($suggestion->service->nom); ?>

                        </span>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($suggestion->agence): ?>
                    <div class="h-px bg-gray-50"></div>
                    <div class="flex justify-between items-center">
                        <span class="text-xs font-medium text-gray-400 uppercase tracking-wide">Agence</span>
                        <span class="text-sm text-gray-600"><?php echo e($suggestion->agence->nom); ?></span>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm text-gray-600"><?php echo e($suggestion->created_at->format('d/m/Y à H:i')); ?></span>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($suggestion->updated_at->ne($suggestion->created_at)): ?>
                    <div class="h-px bg-gray-50"></div>
                    <div class="flex justify-between items-center">
                        <span class="text-xs font-medium text-gray-400 uppercase tracking-wide">Mis à jour</span>
                        <span class="text-sm text-gray-600"><?php echo e($suggestion->updated_at->format('d/m/Y à H:i')); ?></span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="mt-6 flex justify-center gap-5 text-sm">
        <a href="<?php echo e(route('suggestion.form')); ?>" class="text-indigo-600 hover:underline font-medium">
            + Nouveau message
        </a>
        <span class="text-gray-300">|</span>
        <a href="<?php echo e(route('suggestion.suivi')); ?>" class="text-gray-400 hover:text-gray-600">
            Nouvelle recherche
        </a>
    </div>
...
<?php /**PATH C:\Users\HP\Documents\smartsuggest\resources\views/public/suivi.blade.php ENDPATH**/ ?>