...
<form id="mainForm" action="<?php echo e(route('suggestion.enregistrer')); ?>" method="POST">
<?php echo csrf_field(); ?>
...
<div class="max-w-md mx-auto px-4 pb-24 pt-6">
    ...
    <div id="step1" class="step active">
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$val, $emoji, $label, $desc, $grad, $bg]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="type-card border-2 <?php echo e($bg); ?> rounded-2xl p-4 text-center"
                 data-type="<?php echo e($val); ?>"
                 onclick="selectType('<?php echo e($val); ?>', this)">
                <div class="text-3xl mb-2"><?php echo e($emoji); ?></div>
                <div class="font-bold text-gray-800 text-sm"><?php echo e($label); ?></div>
                <div class="text-gray-500 text-xs mt-0.5 leading-tight"><?php echo e($desc); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($serviceSelectionne): ?>
        <input type="hidden" id="preselected_service" value="<?php echo e($serviceSelectionne->id); ?>">
    ...
    <div id="step2" class="step">
        ...
        <div id="serviceList" class="space-y-2">
            ...
            <div class="service-card border-2 border-gray-100 bg-white rounded-2xl px-4 py-3.5 flex items-center gap-3"
                 ...
                 data-name="<?php echo e(strtolower($service->nom . ' ' . optional($service->agence)->nom)); ?>"
                 onclick="selectService('<?php echo e($service->id); ?>', '<?php echo e(addslashes($service->nom)); ?>', this)">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0"
                     style="background:<?php echo e($service->couleur); ?>22; color:<?php echo e($service->couleur); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex-1 min-w-0">
                    <div class="font-semibold text-gray-800 text-sm truncate"><?php echo e($service->nom); ?></div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->agence): ?>
                    <div class="text-xs text-gray-400 truncate"><?php echo e($service->agence->nom); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
    ...
    <div id="step4" class="step">
        ...
        <div class="bg-white rounded-2xl border-2 border-gray-100 p-4 mb-4">
            ...
            <div class="flex justify-center gap-2" id="starRow">
                ...
                <button type="button" class="star-btn text-gray-200" data-star="<?php echo e($i); ?>" onclick="setStar(<?php echo e($i); ?>)">★</button>
...
document.addEventListener('DOMContentLoaded', () => {
    <?php if($serviceSelectionne): ?>
    // Auto-sélectionner le service dans la liste (étape 2)
    const card = document.querySelector('[data-id="<?php echo e($serviceSelectionne->id); ?>"]');
    if (card) {
        card.classList.add('selected');
        card.querySelector('.check-icon').classList.remove('hidden');
    }
...
<?php /**PATH C:\Users\HP\Documents\smartsuggest\resources\views/public/suggestion.blade.php ENDPATH**/ ?>